...
@Data
@Entity
@Table(name = "vw_socios_activos_con_medidor")
@Immutable
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode(callSuper=false)
public class SocioActivoConMedidor extends Auditable implements Serializable {
	/**
	* 
	*/
	private static final long serialVersionUID = -7179738591302496492L;
