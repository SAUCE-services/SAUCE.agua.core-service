...
@Data
@Entity
@Table(name = "vw_deudores_plan_corte")
@Immutable
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode(callSuper = false)
public class DeudorPlanCorte extends Auditable implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 7891784895496959815L;
