...
@Data
@Entity
@Table(name = "vw_socios_activos")
@Immutable
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode(callSuper = false)
public class SocioActivo extends Auditable implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8396182447962339811L;
