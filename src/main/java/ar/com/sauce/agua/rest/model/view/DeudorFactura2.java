...
@Data
@Entity
@Table(name = "vw_deudores_factura_2")
@Immutable
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode(callSuper = false)
public class DeudorFactura2 extends Auditable implements Serializable, ICliente {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1721398653905751277L;
