...
@Data
@Entity
@Table(name = "vw_activos_con_medidor")
@Immutable
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode(callSuper=false)
public class ActivoConMedidor extends Auditable implements Serializable, ICliente {
	/**
	 * 
	 */
	private static final long serialVersionUID = 4198759530857413703L;
